                  ...
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                      <div>
                        ...
                        <input
                          ...
                          disabled={!isEditing}
                          className="mt-1 block w-full border border-gray-200 rounded-xl shadow-sm py-2 px-3 focus:outline-none focus:ring-2 focus:ring-[#A8E0D8] focus:border-transparent disabled:bg-gray-50"
                        />
                      </div>
                      <div>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          disabled
                          className="mt-1 block w-full border border-gray-200 rounded-xl shadow-sm py-2 px-3 bg-gray-50 text-gray-500"
                        />
                      </div>
                      <div>
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-600">Subscription (days)</label>
                        <input
                          type="text"
                          name="subscription"
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-600">Subscription Last Updated</label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-600">Subscription Ends On</label>
                        <input
                          type="text"
                    ...
                    {isEditing && (
                      <div className="flex justify-end">
                        <button
                          type="submit"
                          className="inline-flex items-center px-6 py-2 border border-transparent rounded-xl shadow-sm text-sm font-medium text-white bg-gray-900 hover:bg-gray-800 transition-all active:scale-95"
                        >
                          Save Changes
                        </button>
                      </div>
